...
function ApiClient() {
  ...
  /**
   * @todo optionally allow a different return node (AiStatistics?)
   * 
   * @param {string} action
   * @param {object} args
  ...
  /** @todo verify that all params are replaced */

 ...
 * 
 * 
 * @todo figure out if map name or playlist name is really specific enough
 *       to be a cardinal key, 
 *       or if it needs to respect map and playlist variants
 *       
 * @todo date parsing
...
/***************** end gamehistory props **************************************/
    ...
    setters = {
      ...
      'PlaylistName': function(value) {
        properties.PlaylistName = value;
        // todo: also set id
